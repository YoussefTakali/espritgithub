...
public ResponseEntity<TaskDTO> updateTask(
    ...
    public ResponseEntity<List<Task>> getVisibleTasksForMember(@PathVariable String memberId) {
        try {
            List<Task> tasks = taskService.getVisibleTasksForGroupMember(memberId);
