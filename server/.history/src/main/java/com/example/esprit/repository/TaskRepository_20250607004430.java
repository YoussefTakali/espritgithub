...
@Query("""
    SELECT 
        ...
        COUNT(CASE 
              WHEN ta.status = 'PENDING' AND 
                   ta.endDate BETWEEN CURRENT_DATE AND :endOfWeek 
              THEN 1 
        END)
    FROM TaskAssignment ta
    WHERE ta.task.createdBy = :teacherId
""")
Object[] countPendingAndEndingThisWeekByTeacher(@Param("teacherId") String teacherId,
