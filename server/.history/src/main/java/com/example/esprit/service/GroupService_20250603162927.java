...
public Group updateGroup(Long groupId, GroupRequestDTO dto) {
    System.out.println("Group ID: " + groupId);
    System.out.println("DTO projectId: " + dto.getProjectId());
    System.out.println("DTO classId: " + dto.getClassId());

    if (dto.getProjectId() == null) {
        throw new IllegalArgumentException("Project ID in DTO is null");
    }
    if (dto.getClassId() == null) {
        throw new IllegalArgumentException("Class ID in DTO is null");
    }
    ...
    existingGroup.setProject(project);
    existingGroup.setClasse(classe);
