...
public List<GroupResponseDTO> getGroupsTest() {
    return groupRepository.findAll().stream()
            .map(group -> new GroupResponseDTO(
                group.getId(),
                group.getName(),
                group.getProject() != null ? group.getProject().getName() : null,
                group.getClasse() != null ? group.getClasse().getName() : null,
                group.getMemberIds(),
                group.getProject() != null ? group.getProject().getId() : null,
                group.getClasse() != null ? group.getClasse().getId() : null
            ))
