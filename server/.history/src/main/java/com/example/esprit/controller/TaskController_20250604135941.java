...
public ResponseEntity<TaskDTO> updateTask(
    ...
    // }
    @GetMapping("/member/{memberId}/visible")
    public ResponseEntity<List<TaskSummaryDTO>> getVisibleTasksForMember(@PathVariable String memberId) {
        try {
            List<TaskSummaryDto> tasks = taskService.getVisibleTasksForGroupMember(memberId);
